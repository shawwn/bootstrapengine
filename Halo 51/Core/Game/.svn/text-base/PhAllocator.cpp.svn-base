...
PhAllocator::PhAllocator() : mNbAllocatedBytes(0), mHighWaterMark(0), mTotalNbAllocs(0), mNbAllocs(0), mNbReallocs(0)
{
...
void* PhAllocator::malloc(size_t size)
{
...
void* PhAllocator::mallocDEBUG(size_t size, const char* file, int line)
{
	printf("Obsolete code called!\n");
	return NULL;
}
...
void* PhAllocator::realloc(void* memory, size_t size)
{
...
void PhAllocator::free(void* memory)
{
	if(memory == NULL)
	{
